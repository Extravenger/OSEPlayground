...
Another Process Injection technique that loads the shellcode remotely, thanks to [saulgoodman](https://github.com/saulg00dmin) for porting this technique to csharp.<br>
