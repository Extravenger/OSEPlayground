...
- [Invoke-PrivescCheck]([url](https://raw.githubusercontent.com/itm4n/PrivescCheck/refs/heads/master/PrivescCheck.ps1)) `-Report PrivescCheck_$($env:COMPUTERNAME) -Format HTML`
- ``
