...
Then we can use [Invoke-RunasCs.ps1]([url](https://github.com/antonioCoco/RunasCs/blob/master/Invoke-RunasCs.ps1)) to get code execution as the newly created amit user:
